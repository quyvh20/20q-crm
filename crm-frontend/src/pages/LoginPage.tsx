    ...
    <div className="min-h-screen bg-muted/30 flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <Card className="p-8">
          ...
          {notice && (
            <div role="status" className="mb-4 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-sm text-emerald-600 dark:text-emerald-400">
              {notice}
            </div>
          )}
          ...
          {error && (
            <div role="alert" className="mb-4 rounded-lg border border-destructive/30 bg-destructive/10 px-3 py-2 text-sm text-destructive">
              ...
              <p className="mt-2 text-xs text-destructive/80">
                ...
                <Link to="/forgot-password" className="underline hover:no-underline">send yourself a reset link</Link> to set one.
              </p>
            </div>
          )}
