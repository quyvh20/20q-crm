...
const BASE = 'https://20q-crm-production.up.railway.app';
...
async function main() {
  const EMAIL = 'live_admin@20q.com';
  const PASSWORD = 'password123';

  console.log('1. Registering super test org on LIVE SERVER...');
  const reg = await post('/api/auth/register', {
    email: EMAIL,
    password: PASSWORD,
    first_name: 'Live',
    last_name: 'Admin',
    org_name: 'Live Test Corp',
  });
  ...
  await put('/api/knowledge-base/company', { content: "Live Test Corp is a leading software provider established in 2026. We pride ourselves on creating high quality SaaS solutions." }, token);
  ...
  console.log('\n\n✅ ALL SEEDING COMPLETE ON LIVE SERVER');
  console.log('----------------------------------------------------');
